...
- To make it much more easier to the end-users while assigning the values to the selection field's either we can autosuggest the values or provide an F4-help for the field.
